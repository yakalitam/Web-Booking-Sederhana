                            ...
                            <form>
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="collumns">
                                                <a class="button is-small is-primary" href="<?php echo base_url('Form_Konfirmasi/') ?>"><span class="icon is-small">
                                                ...
                                                <?php echo anchor('jadwalbookingP/hapus/' . $bkg->id, '<div class="button is-small is-danger" style="border-radius: 5px;">
                                                <span class="icon is-small">
