                        ...
                        <table class="table is-bordered table-striped table-hover">
                            ...
                            <tbody class="has-text-centered table-secondary">
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <form method="POST" action="<?php echo base_url('datapelangganP/update_pembayaran') ?>">
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('datapelangganP') ?>" class="button is-small is-danger"> Batal </a>
                                            </td>
