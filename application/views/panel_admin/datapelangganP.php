<section class="section is-main-section">
    ...
    <div class="card has-table has-mobile-sort-spaced">
        <header class="card-header">
            ...
            <a href="<?php echo base_url('datapelangganP') ?>" class="card-header-icon">
                <span class="icon">
                            ...
                            <form>
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="collumns">
                                                <a class="button is-small is-primary" href="<?php echo base_url('Form_Konfirmasi/Pembayaran') ?>"><span class="icon is-small">
                                                        <i class="fas fa-info"></i>
                                                    </span></a>

                                                <?php echo anchor('datapelangganP/hapus/' . $bkg->id, '<div class="button is-small is-danger" style="border-radius: 5px;">
