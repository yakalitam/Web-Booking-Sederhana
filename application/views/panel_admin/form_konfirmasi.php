    ...
    <div class="container">
        <div class="card has-mobile-sort-spaced">
            <header class="card-header">
                ...
                <a href="<?php echo base_url('jadwalbookingP') ?>" class="card-header-icon">
                    <span class="icon">
                        ...
                        <table class="table is-bordered table-striped table-hover">
                            ...
                            <tbody class="has-text-centered table-secondary">
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <form method="POST" action="<?php echo base_url('jadwalbookingP/update_booking') ?>">
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td class=" collumns">
                                                ...
                                                if ($bkg->status_booking == "1") {
                                                    ...
                                                    <div class="collumn">
                                                        ...
                                                        <input class="is-checkradio is-primary" type="checkbox" value="1" name="status_booking">
                                                        <label class="mr-3">Konfirmasi</label>

                                                        <input class="is-checkradio is-primary" type="hidden" value="<?php echo $bkg->id ?>" name="id">
                                                        <input class="is-checkradio is-primary" type="checkbox" value="2" name="status_booking">
                                                        <label class="mr-3">Tolak</label>
                                                    </div>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('jadwalbookingP') ?>" class="button is-small is-danger"> Batal </a>
                                            </td>
