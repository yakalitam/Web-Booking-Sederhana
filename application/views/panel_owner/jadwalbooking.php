                            ...
                            <form>
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <tr>
                                        ...
                                        <!-- <td class="collumns">
                                            <a class="button is-small is-danger" href="<?php echo base_url('Konfirmasibooking'); ?>" style="border-radius: 5px;">
                                        ...
                                        <td>
                                            <div class="collumns">
                                                <a class="button is-small is-primary" href="<?php echo base_url('Form_Konfirmasi/owner') ?>"><span class="icon is-small">
                                                ...
                                                <?php echo anchor('JadwalBooking/hapus/' . $bkg->id, '<div class="button is-small is-danger" style="border-radius: 5px;">
                                                <span class="icon is-small">
