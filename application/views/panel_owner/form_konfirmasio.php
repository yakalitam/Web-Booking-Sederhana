    ...
    <div class="container">
        <div class="card has-mobile-sort-spaced">
            <header class="card-header">
                ...
                <a href="<?php echo base_url('JadwalBooking') ?>" class="card-header-icon">
                    <span class="icon">
                        ...
                        <table class="table is-bordered table-striped table-hover">
                            ...
                            <tbody class="has-text-centered table-secondary">
                                ...
                                foreach ($booking as $bkg) : ?>
                                    <form method="POST" action="<?php echo base_url('JadwalBooking/update_booking') ?>">
                                        <tr>
                                            <td><?php echo $no++ ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('JadwalBooking') ?>" class="button is-small is-danger"> Batal </a>
                                            </td>
