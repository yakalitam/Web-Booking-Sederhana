    ...
    <div id="app">
                    ...
                    <div class="navbar-item has-dropdown has-dropdown-with-icons has-divider has-user-avatar is-hoverable">
                        <?php if ($this->session->userdata('username')) { ?>
                            ...
                            <div class="navbar-dropdown">
                                <a href="akunP" class="navbar-item">
                                    <span class="icon">
        ...
        <aside class="aside is-placed-left is-expanded ">
            ...
            <div class="menu is-menu-main">
                ...
                <ul class="menu-list">
                    <li>
                        <a href="<?php echo base_url('DashboardAdmin') ?>" class="is-active router-link-active has-icon">
                            <span class="icon">
                ...
                <ul class="menu-list">
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo base_url('jadwalbookingP') ?>">
                                    <span>Data Booking</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('datapelangganP') ?>">
                                    <span>Data Pembayaran</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('akunP') ?>">
                                    <span>Akun </span>
                                </a>
                            </li>
                        </ul>
                ...
                <ul class="menu-list">
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo base_url('gajiP') ?>">
                                    <span>Gaji</span>
                                </a>
                            </li>
                        </ul>
