...
<head>
    ...
    <section class="hero is-fullheight" style="background-image: url(assets/img/wedding_4.jpg);">
        <div class="hero-head">
                ...
                <div class="container mt-4">
                    <div class="navbar-brand">
                        <a class="navbar-item" href="Welcome">
                            ...
                            <img src="<?= base_url('assets/img/logo_1.png'); ?>" width="200px;" height="200px;">
                    ...
                    <div id="navMenu" class="navbar-menu navbar">
                        <div class="navbar-end">
                            ...
                            <a href="Welcome" class="navbar-item has-text-danger-light">Home</a>
                            <a href="Galeri" class="navbar-item has-text-danger-light">Galeri</a>
                            <a href="AboutUs" class="navbar-item has-text-danger-light">About Us</a>
                            <a href="Booking" class="navbar-item has-text-danger-light">Booking</a>
