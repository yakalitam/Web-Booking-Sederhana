...
<head>
    ...
    <section class="hero is-fullheight" style="background-image: url(assets/img/wedding_2.jpg);">
        <div class="hero-head">
                ...
                <div class="container mt-4">
                    ...
                    <div id="navMenu" class="navbar-menu navbar">
                        <div class="navbar-end">
                            ...
                            <a href="Welcome" class="navbar-item has-text-warning-dark">Home</a>
                            <a href="Galeri" class="navbar-item has-text-warning-dark">Galeri</a>
                            <a href="AboutUs" class="navbar-item has-text-warning-dark">About Us</a>
                            <a href="Booking" class="navbar-item has-text-warning-dark">Booking</a>
        ...
        <div class="container has-text-centered mt-6">
            <h1 class="navbar1 has-text-centered has-text-warning-dark">AAPro Photo Studio</h1>
            <h1 class="navbar2 has-text-warning-dark">"Bukan Promo Photo Sepuasnya, Bayar Seikhlasnya"</h1>
